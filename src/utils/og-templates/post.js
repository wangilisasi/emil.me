 ...
 *
 * CUSTOMIZATION: We override the default behavior to show the website domain
...
export default async (post) => {
  return satori(
    ...
    },
    {
      ...
      height: 630,
      embedFont: true,
      fonts: await loadGoogleFonts(post.data.title + post.data.author + "your-domain.com" + "by"),
    }
  );
};
